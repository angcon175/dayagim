                            ...
                            <form class="form-horizontal" action="{{ route('module.ad.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="product_status_id" id="product_status"
                                                    ...
                                                    <option value="0">{{ __('Like') }}</option>
                                                    <option value="1">{{ __('Used') }}</option>
                                                    <option value="2">{{ __('Requires Fixing') }}</option>
                                                    <option value="3">{{ __('Irrelevant') }}</option>
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="delivery_sell_id" id="delivery_sell"
                                                    ...
                                                    <option value="0">{{ __('Delivery') }}</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="input-field--textarea">
                                                <x-forms.label name="features" for="feature" :required="false"/>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        @endphp
                                        @if ($map == 'map-box')
                                            <div class="map mymap" id="map-bo"></div>
                                        @endif
                                        @if ($map == 'google-map')
                                            <div>
