                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <x-forms.label name="Product Status" for="product_status" />
                                                <select name="product_status_id" id="product_status"
                                                    ...
                                                    <option value="0"
                                                        {{ $ad->product_status_id == '0' ? 'selected' : '' }}>
                                                        {{ __('Like') }}</option>
                                                    <option value="1"
                                                        {{ $ad->product_status_id == '1' ? 'selected' : '' }}>
                                                        {{ __('Used') }}</option>
                                                    <option value="2"
                                                        {{ $ad->product_status_id == '2' ? 'selected' : '' }}>
                                                        {{ __('Requires Fixing') }}</option>
                                                    <option value="3"
                                                        {{ $ad->product_status_id == '3' ? 'selected' : '' }}>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <x-forms.label name="subcategory" :required="false" />
                                            ...
                                            <div class="col-md-4 mb-3" id="brand_div">
                                                <x-forms.label name="brand" :required="false" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <div class="input-field--textarea">
                                                    <x-forms.label name="features" :required="false"/>
