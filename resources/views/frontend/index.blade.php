...
@section('content')
    @php
        $getlang = session()->get('set_lang');
    @endphp
    <!-- banner section start  -->
    @if($getlang == 'en')
        <div class="banner banner--two" style="background-image: url('{{ asset($cms->home_main_banner) }}'); background-position: center;background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
    ...
    @else
        <div class="banner banner--two" style="background-image: url('{{ asset($cms->home_counter_background) }}'); background-position: center;background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 class="text--display-3 banner__title animate__animated animate__bounceInDown">
       ...
       {{-- <section class="download section pb-lg-0">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <img src="{{ $cms->home_mobile_app_banner }}" class="download__img-content w-100" / style="height: 447px !important;">
                    </div>
                    <div class="col-lg-6">
