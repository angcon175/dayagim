                                                    ...
                                                    <div class="accordion-item list-sidebar__accordion-inner-item">
                                                        <h2 class="accordion-header"
                                                            ...
                                                            <div class="accordion-button list-sidebar__accordion-inner-button {{ isActiveCategorySidebar($category) ? '' : 'collapsed' }}"
                                                                ...
                                                                data-bs-target="#ac_{{ $category->id }}Collapse"
                                                                aria-expanded="true"
                                                                aria-controls="ac_{{ $category->id }}Collapse">
                                                        ...
                                                        <div id="ac_{{ $category->id }}Collapse"
                                                                ...
                                                                @foreach ($category->subcategories as $subcategory)
                                                                    <div class="list-sidebar__accordion-inner-body--item">
                                                                        <div class="form-check">
                                                                            ...
                                                                            <x-forms.label name="{{ $subcategory->name }}" for="{{ $subcategory->slug }}"  class="form-check-label" />
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                            </div>
