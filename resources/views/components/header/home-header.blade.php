            ...
            <div class="navigation-bar">
                ...
                <div class="navigation-bar__buttons">
                    @if (auth('user')->check())
                        ...
                        <a href="{{ route('frontend.post') }}" class="btn post_ads_hidden_mobile">
                            <span class="icon--left sm-block">
                    ...
                    @else
                        ...
                        <a href="{{ route('users.login') }}" class="btn login_required post_ads_hidden_mobile">
                             <span class="icon--left sm-block">
                                <x-svg.image-select-icon />
                            </span>
                            {{ __('post_ads') }}
