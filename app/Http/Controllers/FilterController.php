...
class FilterController extends Controller
{
    ...
    public function adsByCategory($slug)
    {
        ...
        // return $category;
        $data['adlistings'] = Ad::where('category_id', $category->id)->select('id', 'title', 'slug', 'user_id', 'category_id', 'subcategory_id', 'price', 'thumbnail', 'country', 'region')
            ->activeCategory()
